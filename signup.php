    ...
    <div class="container">
        ...
        <div class="login-form">
            ...
            <form method="POST" action="controllers/auth.php?action=signup">
                ...
                <button type="submit" class="btn btn-custom col-12 mb-3 rounded-5">Register</button>
            </form>
            <p class="small text-muted text-center mb-1">Already have an account? <a href="login.php">Log in</a></p>
        </div>
    </div>
